...
if(date>'05:00:00' && date<'17:00:00'){
    body.style.background='url(Images/background_morning_img1.webp) no-repeat center/cover fixed';
}

else{
    body.style.background='url(Images/background_night.jpg) no-repeat center/cover fixed';
}
...
const getdata= async (city,value) =>{
    ...
    // console.log(data);
    // for AQI ////////////////
    let URL2=`https://api.openweathermap.org/data/2.5/air_pollution?lat=${lat}&lon=${lon}&appid=1db1616b48f7be51d4b816945a4f8912`;
    ...
    if(date>'05:00:00' && date<'17:00:00'){
        img_moon_sun.src="Images/cartton_sun.png";
    }
    else if(data['weather'][0]['description']=="clear sky" &&  date>'17:00:00'){
        img_moon_sun.src="Images/cartton_moon.png";
        body.style.background='url(Images/background_night.jpg) no-repeat center/cover';
    }
    else if(data['weather'][0]['description']=="broken clouds" && date>'17:00:00'){
        body.style.background='url(Images/broken_cloud_night.jpg) no-repeat center/cover';
    }
        ...
        body.style.background='url(Images/background_rain.jpg) no-repeat center/cover';
    }
...
city_name.addEventListener("keypress", function(event) {
    if (event.keyCode === 13) {
        ...
        p=new Audio('sounds/enter-button.mp3');
        p.play();
        search_logo.click();
    }
});
...
mic.addEventListener('click',function(){
    var audio = new Audio('sounds/mic_sound.mp3');
    audio.play();
    recognition.start();
});
...
//     let nspeech = new SpeechSynthesisUtterance();
//     nspeech.text = 'Welcome to climavox. How can I assist you today?';
//     nspeech.lang='en-US';
//     window.speechSynthesis.speak(nspeech);
// });