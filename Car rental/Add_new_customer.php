...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-md-8 order-md-1 container">
      <h4 class="mb-3">Adding New Customer</h4>
    ...
    <button class="btn btn-primary btn-lg btn-block" style="width:15rem;" type="submit" fdprocessedid="w0mqbh">Add New Customer</button>
</div>
...
$empId=$_POST['empId'];
  ...
  $sql="INSERT INTO customers (street_address, city, province, postal_code, phone_number, driving_license_number, first_name, last_name,employee_id) 
  VALUES ('$street', '$city', '$province', '$postal_code', '$phone_number', '$dlnumber', '$fname', '$lname','$empId');
  ";
