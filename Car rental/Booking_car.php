...
<div class="container">
  ...
  <input type="file" id="fileInput" style="display: none;" accept="image/*">
    ...
    <div class="col-md-8 order-md-1 container">
      <h4 class="mb-3">Book New Car</h4>
      <form class="needs-validation" method="post">
        <div class="row">
          <div class="col-md-6 mb-3">
            <label for="from">From</label>
            <input type="text" class="form-control" id="from" name='from' placeholder="" value="" required="" fdprocessedid="qm5bgc">
    ...
    <button class="btn btn-primary btn-lg btn-block" style="width:15rem;" type="submit" fdprocessedid="w0mqbh">Pay Latter</button>
</div>
