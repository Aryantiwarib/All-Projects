...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-md-8 order-md-1 container">
      <h4 class="mb-3">Adding New Car</h4>
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
  ...
  $sql="INSERT INTO cars1 (make, model, year, color, class, license_plate, odometer_reading, tank_status) 
  VALUES ('$make', '$model', '$year', '$color', '$class', '$dlnumber', '$od_rating', '$tank_status');
  ";
