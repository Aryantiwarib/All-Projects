...
<html lang="en">
  ...
  <div class="form-group">
    <label for="exampleInputPassword1">Driving License Number</label>
    <input type="number" class="form-control" id="exampleInputPassword1"name='DrivingLicenseNumber' placeholder="Enter your License Number">
    <small id="emailHelp" class="form-text text-muted">We'll never share your License number with anyone else.</small>
  </div>
