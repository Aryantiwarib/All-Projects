...
<head>
    ...
    <title>Last Name Of The Customers</title>
</head>
...
<body>
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        // WHERE TABLE_SCHEMA = 'car_rental' AND TABLE_NAME = 'customers';";
        ...
        //         <strong>Alert!</strong>Please Enter The Column Name OR Column Name Must be valid!
        ...
        <p style='color:#bdc7ff; font-weight:bold;   ' >Last Name</p>
      </div>";
